...
from .views import friend_list,get_user,get_all_user, send_friend_request, accept_friend_request, reject_friend_request, cancel_friend_request,get_user_friend_request_list,unfriend,create_user
