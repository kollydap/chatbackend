...
from .views import friend_list,get_user,get_all_user, get_a_user,send_friend_request, accept_friend_request, reject_friend_request, cancel_friend_request,get_user_friend_request_list,unfriend,create_user,get_user_friend_list
...
urlpatterns = [
    ...
    path('get-user-friend-list/<int:pk>',get_user_friend_list, name="get_user_friendlist"),
